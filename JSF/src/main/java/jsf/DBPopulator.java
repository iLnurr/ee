...
public class DBPopulator {
    ...
    private void createDummyData() {
        bookEJB.createBook(new Book("The Hitchhiker's Guide to the Galaxy", "Science fiction comedy book", 23.99f,354, Boolean.TRUE));
        bookEJB.createBook(new Book("Harry Potter and the Goblet of Fire",  "Science fiction (Book 4)", 19.79f, 734, Boolean.TRUE));
...
//    bookEJB.createBook(new Book("The Lord of the Rings", 50.4f, "Science fiction comedy book", 1216, Boolean.TRUE));
        bookEJB.createBook(new Book("Java EE 6 with GlassFish 3", "Just fantastic", 31.49f,354, Boolean.TRUE));
